...
function getComponentName(target) {
  return (true ? typeof target === "string" && target : false) || // $FlowFixMe
...
var DefaultGroupedTag = function() {
  ...
  _proto.getGroup = function getGroup(group) {
    ...
    var endIndex = startIndex + length;
    for (var i = startIndex; i < endIndex; i++) {
      css2 += this.tag.getRule(i) + "\n";
    }
    return css2;
  };
  return DefaultGroupedTag2;
}();
var groupIDRegister = /* @__PURE__ */ new Map();
var reverseRegister = /* @__PURE__ */ new Map();
var nextFreeGroup = 1;
...
var outputSheet = function outputSheet2(sheet) {
  ...
  for (var group = 0; group < length; group++) {
    ...
    css2 += "" + rules + selector + '{content:"' + content + '"}\n';
  }
  return css2;
};
...
var StyleSheet = function() {
  ...
  _proto.registerName = function registerName(id, name) {
    ...
    if (!this.names.has(id)) {
      var groupNames = /* @__PURE__ */ new Set();
      groupNames.add(name);
...
function useStyledComponentImpl(forwardedComponent, props, forwardedRef) {
  ...
  if (shouldFilterProps) {
    for (var key in computedProps) {
      ...
      } else if (key !== "as" && key !== "forwardedAs" && (!isTargetTag || is_prop_valid_browser_esm_default(key))) {
